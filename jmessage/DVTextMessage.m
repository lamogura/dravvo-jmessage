...
- (id)initWithJSONString:(NSString *)jsonString {
    return [[DVTextMessage alloc] initWithDictionary:[jsonString JSONValue]];
}
...
+ (NSArray *)textMessageArrayFromJSON: (NSString *)jsonString {
    ...
    for (NSDictionary *msg in jsonMessages) {
        [messages addObject:[[DVTextMessage alloc] initWithDictionary:msg]];
    }
